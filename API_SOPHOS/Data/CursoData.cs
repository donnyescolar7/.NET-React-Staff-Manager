...
namespace API_SOPHOS.Data
{
    public class CursoData
    {
        ...
        public static List<Curso> ListarSoloDisponibles()
        {
            List<Curso> ListaUsuario = new List<Curso>();
            using (SqlConnection oConexion = new SqlConnection(Conexion.rutaConexion))
            {
                SqlCommand cmd = new SqlCommand("curso_listar_solo_disponibles", oConexion);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static bool EliminarRCursoEstudiante(int idcurso, int idestudiante)
        {
            using (SqlConnection oConexion = new SqlConnection(Conexion.rutaConexion))
            {
                SqlCommand cmd = new SqlCommand("r_curso_estudiante_eliminar", oConexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@idcurso", idcurso);
